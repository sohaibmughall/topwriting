            ...
            <>
                <aside className="slide-bar">
                    <div className="close-mobile-menu">
                        <a href="javascript:void(0);"><i className="ti-close"></i></a>
                    </div>
                    ...
                    <div className="sidebar-info">
                        ...
                        <div className="sidebar-content mb-45">
                            ...
                            <a className="thm_btn" href="contact.html">Contact us<i className="fal fa-long-arrow-right"></i></a>
                        </div>
                ...
                <main>
                   ...
                   <Link to="/ordernow" className="thm_btn thm_btn-2">Order Now<i className="fal fa-long-arrow-right"></i></Link>
                                ...
                                <div className="col-lg-6">
                                    <div className="about_content mb-30">
                                        <div className="sec_title">
                                            ...
                                            <p>Rorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim ad minim veniam, quis nostrudye. magna aliqua Utey Tim ad minim veniam, quis nostrudye.</p>
                                        </div>
                                        <div className="row">
                    ...
                    <section className="counter_area counter_padding" data-overlay="7" data-background="assets/img/bg/counter_bg.jpg">
                        <div className="container">
                            <div className="row">
                                    ...
                                    <div className="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                                        <div className="js_text">
                                            ...
                                            <form className="js_from" action="#">
                                                ...
                                                <button className="thm_btn thm_btn-2">submit now<i className="fal fa-long-arrow-right"></i></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section className="testimonial_area">
                        <div className="container-fluid p-0">
                            <div className="row g-0">
                                <div className="col-lg-6">
                                    <div className="tm_left-wrap" data-overlay="7" data-background="assets/img/bg/tm_bg.jpg">
                                        <div className="sec_title">
                                            <h2>Our happy student say</h2>
                                            <p>Rorem ipsum dolor sit amet consectetur adipisicing elit. Delectus quas aperiam cum eligendi libero iusto nostrum eaque alias quasi minima maxime provident, dolor mollitia quis inventore impedit, deserunt blanditiis quos cumque quibusdam eum quidem.</p>
                                        </div>
                                        <div className="tm_btn">
                                            <a className="thm_btn thm_btn-2" href="courses.html">View All Courses<i className="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                        ...
                                        <div className="testimonial_active owl-carousel">
                                            <div className="testimonial_single">
                                                <div className="tm_thumb">
                                                    <img src="assets\img\testimonial\tm_author.jpg" alt="" />
                                                </div>
                                                <div className="tm_text">
                                                    <p>Rorem ipsum dolor sit amet, consectetur adipisicing elit, sed eiusmod tempor incididunt ut labore et dolore magna aliqua.enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                    ...
                    <section className="blog_area blog_top-space pt-190 pb-90">
                        <div className="container">
                            <div className="row align-items-center mb-15">
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="crs_btn text-md-end mb-20">
                                        <a className="thm_btn" href="blog.html">View all<i className="fal fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div className="row justify-content-md-center">
                                <div className="col-lg-4 col-md-6">
                                    <div className="blog_single mb-30">
                                        <h3 className="title"><a href="blog-details.html">Fashion and Luxury Fashion in a Changing Issues</a></h3>
                                        <ul className="meta ul_li">
                                            <li><a href="#"><i className="fal fa-user"></i>Rasalina De</a></li>
                                            <li><i className="fal fa-heart"></i>36 like</li>
                                            <li><a href="#"><i className="fal fa-comments"></i>8 Comments</a></li>
                                        </ul>
                                        ...
                                        <a className="blog_btn" href="blog-details.html"><i className="ti-plus"></i></a>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="blog_single mb-30">
                                        <h3 className="title"><a href="blog-details.html">Making Music with Other Super People</a></h3>
                                        <ul className="meta ul_li">
                                            <li><a href="#"><i className="fal fa-user"></i>Wasim Mia</a></li>
                                            <li><i className="fal fa-heart"></i>53 like</li>
                                            <li><a href="#"><i className="fal fa-comments"></i>21 Comments</a></li>
                                        </ul>
                                        <div className="blog_thumb">
                                            <a href="blog-details.html">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="blog_single mb-30">
                                        <h3 className="title"><a href="blog-details.html">The Power of Podcast for  Story telling system</a></h3>
                                        <ul className="meta ul_li">
                                            <li><a href="#"><i className="fal fa-user"></i>Rasalina De</a></li>
                                            <li><i className="fal fa-heart"></i>76 like</li>
                                            <li><a href="#"><i className="fal fa-comments"></i>9 Comments</a></li>
                                        </ul>
                                        <div className="blog_thumb">
                                            <a href="blog-details.html">
