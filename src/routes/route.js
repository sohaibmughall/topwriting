      ...
      <Router ref={this.myRef}>
        <Switch>
          <Layout>
            ...
            <Route
              exact
              path="/admissionServices"
              component={Admissionservices}
            />
            <Route
              exact
              path="/dissertationServices"
              component={Dissertationservices}
            />
            <Route exact path="/assignments" component={Assignments} />
            <Route
              exact
              path="/writemydessertation"
              component={writemydessertation}
            />
            <Route
              exact
              path="/assignmentwriter"
              component={AssignmentWriter}
            />
            ...
            <Route
              exact
              path="/buydisseratation"
              component={BuyDisseratation}
            />
